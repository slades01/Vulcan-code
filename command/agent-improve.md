...
7. Include the verification commands that must pass after any later apply step: `vulcan --version`, `vulcan agent list`, focused `vulcan debug agent <name>` checks, and the relevant benchmark task/scorecard update.
