...
4. Use GLM 5.2 for bulk benchmark lanes; reserve GPT-5.5-fast for scoring, synthesis, security, vulcan config changes, and ambiguous failures.
5. Do not edit vulcan config from this command. If improvements are found, return proposed diffs and verification commands.
