...
- Use GLM 5.2 for bulk discovery, architecture, debugging, implementation, verification, review, performance, docs, and memory; reserve GPT-5.5-fast for top synthesis, security, VulcanCode config changes, agent evaluation, and hard ambiguity.
