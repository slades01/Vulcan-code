...
4. Escalate to GPT-5.5-fast only for top synthesis, security, opencode config changes, repeated failures, or high-stakes ambiguity; use GPT-5.5-fast `low` effort by default.
